...
<head>  
  <meta charset="UTF-8" />  
  <title>George – Every Instinct You Have Is Wrong</title>  
  ...
  <div class="shell">  
    <header>  
      <div class="brand">  
        ...
        <div class="brand-text">  
          <div class="brand-name">George</div>  
          <div class="brand-tag">Every instinct is wrong</div>  
        </div>  
      </div>  
    ...
    <main>  
      <section class="hero">  
        ...
        <h1 class="hero-title">  
          <span>Every instinct you have is wrong.</span>  
        </h1>  
  
        <p class="hero-subtitle">  
          George watches the crowd, measures what they believe, and generates a contrarian sentiment signal for traders who know they are their own worst <strong>enemy</strong>.  
        </p>  
        ...
        <p class="note">  
          George is an experimental research tool and not financial advice. You are responsible for your own trading decisions; assume George will be catastrophically  
          <strong>wrong</strong>.  
        </p>  
        ...
        <section class="ticker-section" aria-label="Watchlist">  
          <div class="ticker-header">  
            <div class="ticker-title">Core watchlist · 13 tickers</div>  
            <div class="ticker-search">  
              <span class="ticker-search-icon">🔍</span>  
              <input  
                id="tickerSearch"  
                type="text"  
          ...
          <div id="tickerGrid" class="ticker-grid">  
            ...
            <article class="ticker-card" data-symbol="SPY" data-name="S&P 500 ETF">  
              ...
              <div class="ticker-meta">  
                Session bias · <span class="ticker-change pos">+0.8%</span>  
              </div>  
            </article>  
            ...
            <article class="ticker-card" data-symbol="SPX" data-name="S&P 500 Index">  
              ...
              <div class="ticker-meta">  
                Session bias · <span class="ticker-change neg">-0.3%</span>  
              </div>  
            </article>  
            ...
            <article class="ticker-card" data-symbol="QQQ" data-name="Nasdaq 100 ETF">  
              ...
              <div class="ticker-meta">  
                Session bias · <span class="ticker-change pos">+1.1%</span>  
              </div>  
            </article>  
            ...
            <article class="ticker-card" data-symbol="NVDA" data-name="NVIDIA">  
              ...
              <div class="ticker-meta">  
                Session bias · <span class="ticker-change pos">+2.3%</span>  
              </div>  
            </article>  
            ...
            <article class="ticker-card" data-symbol="TSLA" data-name="Tesla">  
              ...
              <div class="ticker-meta">  
                Session bias · <span class="ticker-change neg">-1.5%</span>  
              </div>  
            </article>  
            ...
            <article class="ticker-card" data-symbol="AAPL" data-name="Apple">  
              ...
              <div class="ticker-meta">  
                Session bias · <span class="ticker-change pos">+0.4%</span>  
              </div>  
            </article>  
            ...
            <article class="ticker-card" data-symbol="AMZN" data-name="Amazon">  
              ...
              <div class="ticker-meta">  
                Session bias · <span class="ticker-change pos">+0.9%</span>  
              </div>  
            </article>  
            ...
            <article class="ticker-card" data-symbol="MSFT" data-name="Microsoft">  
              ...
              <div class="ticker-meta">  
                Session bias · <span class="ticker-change pos">+0.6%</span>  
              </div>  
            </article>  
            ...
            <article class="ticker-card" data-symbol="GOOGL" data-name="Alphabet">  
              ...
              <div class="ticker-meta">  
                Session bias · <span class="ticker-change neg">-0.2%</span>  
              </div>  
            </article>  
            ...
            <article class="ticker-card" data-symbol="META" data-name="Meta Platforms">  
              ...
              <div class="ticker-meta">  
                Session bias · <span class="ticker-change pos">+1.6%</span>  
              </div>  
            </article>  
            ...
            <article class="ticker-card" data-symbol="HOOD" data-name="Robinhood">  
              ...
              <div class="ticker-meta">  
                Session bias · <span class="ticker-change neg">-0.7%</span>  
              </div>  
            </article>  
            ...
            <article class="ticker-card" data-symbol="GLD" data-name="Gold ETF">  
              ...
              <div class="ticker-meta">  
                Session bias · <span class="ticker-change pos">+0.3%</span>  
              </div>  
            </article>  
            ...
            <article class="ticker-card" data-symbol="SLV" data-name="Silver ETF">  
              ...
              <div class="ticker-meta">  
                Session bias · <span class="ticker-change neg">-0.4%</span>  
              </div>  
            </article>  
          </div>  
        </section>  
      ...
      <aside class="panel" aria-label="Live Sentiment Panel">  
        ...
        <div class="status-warning">  
          <strong>No active orders.</strong> Live trading integration is disabled while George is recalibrating its model.  
        </div>  
          ...
          <div class="signal-main">  
            ...
            <div class="signal-side">  
              ...
              <div class="signal-meta">  
                Model confidence <strong>0%</strong> · Refreshes in <strong>00:00</strong>  
              </div>  
            </div>  
          </div>  
